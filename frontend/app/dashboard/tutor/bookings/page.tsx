          ...
          return (
            <Card key={booking.id} className="flex flex-col gap-3 p-5 sm:flex-row sm:items-center">
              ...
              <div className="flex-1">
                <div className="flex flex-wrap items-center gap-2"><p className="font-display font-semibold text-ink">Free demo</p><Badge variant={booking.status === 'confirmed' ? 'emerald' : 'indigo'}>{booking.status}</Badge></div>
